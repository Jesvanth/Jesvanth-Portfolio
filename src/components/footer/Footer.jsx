  ...
  return (
    <footer className='footer'>
      <div className='footer__container container'>
          <h1 className='footer__title'>Jesvanth</h1>
          ...
          <div className='footer__social'>
            ...
            <a href='www.linkedin.com/in/jesvanth' className='footer__social-link' target='_blank'>
          ...
          <span className='footer__copy'>&#169; Jesvanth. All Rights Reserved</span>
          </div>
    </footer>
  )
}
