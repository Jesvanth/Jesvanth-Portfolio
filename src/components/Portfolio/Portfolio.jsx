...
import traffic from "../../assets/projectspic/traffic.png"
          ...
          <>
            <div className="work__card">
              ...
              <img src={traffic1} alt='AI' className='cert__img' />
                <h3 className="work__title">Voice Style Transfer using Deep Learning</h3>
                <p className='cert__platform'>Python - (pydub, demucs, spleeter, librosa, torchaudio)</p>
              </a>
            </div>
            ...
            <div className="work__card">
              <a href="https://github.com/Jesvanth/IoT-Project-Smart-Home-Energy-Management-System-Using-Occupancy-Based-Appliance-Control" target="_blank" rel="noreferrer">
                ...
                <h3 className="work__title">IoT Smart Home Energy System</h3>
                <p className='cert__platform'>Arduino, Sensors, Machine Learning</p>
            ...
            <div className="work__card">
              ...
              <img src={traffic} alt='AI' className='cert__img' />
                <h3 className="work__title">Dynamic Traffic Signal Optimization</h3>
                <p className='cert__platform'>Artificial Intelligence, Deep Learning, Machine Learning</p>
              </a>
            </div>
...
<div className="work__card view-more__card">
  <a href="https://github.com/Jesvanth" target="_blank" rel="noreferrer">
